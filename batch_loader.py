...
Adapted from:
        https://github.com/carpedm20/lstm-char-cnn-tensorflow/blob/master/batch_loader.py
"""
...
if __name__ == "__main__":
    loader = BatchLoader(DATA_DIR, "ptb", 
        batch_size=32, seq_length=35, max_word_length=65)
